...
stage1<-function(){
  ...
  if(!fail()){
    ...
    drawTable()
    drawMatrix()
    text(0.5,0.5,label=paste(" You have eat",nrow(e$tail),"fruits!"),cex=1,col=14)
  }
}
...
stage2<-function(){
  ...
  text(0.5,0.3,label=paste("you are lose!"),cex=2,col=2)
  text(0.2,0.05,label="Author:DanZhang",cex=1)
  text(0.5,0.05,label="http://blog.fens.me",cex=1)
  beep(15)
}
...
stage3<-function(){
  ...
  text(0.5,0.3,label=paste("you pause！you have eat",nrow(e$tail),"fruits!"),cex=2,col=2)
  text(0.2,0.05,label="Author:DanZhang",cex=1)
  text(0.5,0.05,label="http://blog.fens.me",cex=1)
}
